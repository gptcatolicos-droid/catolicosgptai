...
const dailyContent  = require('./daily-content-module');
...
dailyContent.scheduleDailyContentJob();
...
app.post('/api/admin/daily-content/run', async (req, res) => {
  ...
  try {
    const result = await dailyContent.runDailyContentJob({ force: req.body && req.body.force === true });
